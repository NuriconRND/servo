...
//!
//! Opt-in on Windows desktop via the `gfx.vsync.enabled` pref. It is not the default because
//! under heavy compositor load (many simultaneous videos) it degrades worse than the
//! free-running timer.
